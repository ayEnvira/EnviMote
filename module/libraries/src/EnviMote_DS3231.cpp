/**************************************************************************/
/*!
    File:     DS3231.cpp: DS3231 Real-Time Clock library
    Author:   Envira Sostenible
    License:  BSD (see license.txt)

    Driver for the DS3231 RTC

    This is a library is based on Eric Ayars library and unix time
...
// Constructor
EnviMote_DS3231::EnviMote_DS3231() {
...
byte EnviMote_DS3231::getSecond() {
	Wire.beginTransmission(CLOCK_ADDRESS);
	Wire.write(0x00);
	Wire.endTransmission();
...
byte EnviMote_DS3231::getMinute() {
	Wire.beginTransmission(CLOCK_ADDRESS);
	Wire.write(0x01);
	Wire.endTransmission();
...
byte EnviMote_DS3231::getHour(bool& h12, bool& AM_PM) {
	byte temp_buffer;
	byte hour;
	Wire.beginTransmission(CLOCK_ADDRESS);
	Wire.write(0x02);
...
byte EnviMote_DS3231::getMonth(bool& Century) {
	byte temp_buffer;
	byte hour;
	Wire.beginTransmission(CLOCK_ADDRESS);
	Wire.write(0x05);
...
void EnviMote_DS3231::setSecond(byte Second) {
	// Sets the seconds 
...
void EnviMote_DS3231::setMinute(byte Minute) {
	// Sets the minutes 
	Wire.beginTransmission(CLOCK_ADDRESS);
	Wire.write(0x01);
...
void EnviMote_DS3231::setHour(byte Hour) {
...
void EnviMote_DS3231::setDoW(byte DoW) {
...
void EnviMote_DS3231::setDate(byte Date) {
	// Sets the Date
	Wire.beginTransmission(CLOCK_ADDRESS);
	Wire.write(0x04);
...
void EnviMote_DS3231::setMonth(byte Month) {
	// Sets the month
	Wire.beginTransmission(CLOCK_ADDRESS);
	Wire.write(0x05);
...
void EnviMote_DS3231::setYear(byte Year) {
	// Sets the year
	Wire.beginTransmission(CLOCK_ADDRESS);
	Wire.write(0x06);
...
void EnviMote_DS3231::setClockMode(bool h12) {
...
float EnviMote_DS3231::getTemperature() {
...
void EnviMote_DS3231::getA1Time(byte& A1Day, byte& A1Hour, byte& A1Minute, byte& A1Second, byte& AlarmBits, bool& A1Dy, bool& A1h12, bool& A1PM) {
	byte temp_buffer;
	Wire.beginTransmission(CLOCK_ADDRESS);
	Wire.write(0x07);
	Wire.endTransmission();
...
void EnviMote_DS3231::getA2Time(byte& A2Day, byte& A2Hour, byte& A2Minute, byte& AlarmBits, bool& A2Dy, bool& A2h12, bool& A2PM) {
	byte temp_buffer;
	Wire.beginTransmission(CLOCK_ADDRESS);
	Wire.write(0x0b);
	Wire.endTransmission();
...
void EnviMote_DS3231::setA1Time(byte A1Day, byte A1Hour, byte A1Minute, byte A1Second, byte AlarmBits, bool A1Dy, bool A1h12, bool A1PM) {
...
void EnviMote_DS3231::setA2Time(byte A2Day, byte A2Hour, byte A2Minute, byte AlarmBits, bool A2Dy, bool A2h12, bool A2PM) {
...
void EnviMote_DS3231::turnOnAlarm(byte Alarm) {
...
void EnviMote_DS3231::turnOffAlarm(byte Alarm) {
...
bool EnviMote_DS3231::checkAlarmEnabled(byte Alarm) {
...
bool EnviMote_DS3231::checkIfAlarm(byte Alarm) {
...
void EnviMote_DS3231::enableOscillator(bool TF, bool battery, byte frequency) {
...
void EnviMote_DS3231::enable32kHz(bool TF) {
...
bool EnviMote_DS3231::oscillatorCheck() {
...
byte EnviMote_DS3231::decToBcd(byte val) {
// Convert normal decimal numbers to binary coded decimal
	return ( (val/10*16) + (val%10) );
}

byte EnviMote_DS3231::bcdToDec(byte val) {
// Convert binary coded decimal to normal decimal numbers
	return ( (val/16*10) + (val%16) );
}

byte EnviMote_DS3231::readControlByte(bool which) {
...
void EnviMote_DS3231::writeControlByte(byte control, bool which) {
